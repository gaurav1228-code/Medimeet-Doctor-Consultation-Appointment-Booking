...
import { APPOINTMENT_CREDIT_COST, USER_ROLES } from "./constants";
...
export async function canBookAppointment() {
  try {
    ...
    if (userData.credits < APPOINTMENT_CREDIT_COST) {
      return {
        canBook: false,
        reason: `Insufficient credits. Need ${APPOINTMENT_CREDIT_COST}, have ${userData.credits}`,
        currentCredits: userData.credits,
        requiredCredits: APPOINTMENT_CREDIT_COST,
      };
    }
